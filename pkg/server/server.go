...
func Start(database *db.DB) error {
	...
	if config.Cfg.WebUI.Enabled {
		...
		router.POST("/api/auth/2fa/setup", auth.Post2FASetup)
		router.OPTIONS("/api/auth/2fa/setup", auth.Options2FASetup)
		router.POST("/api/auth/2fa/confirm", auth.Post2FAConfirm)
		router.OPTIONS("/api/auth/2fa/confirm", auth.Options2FAConfirm)
		router.POST("/api/auth/2fa/verify", auth.Post2FAVerify)
		router.OPTIONS("/api/auth/2fa/verify", auth.Options2FAVerify)
		router.POST("/api/auth/2fa/disable", auth.Post2FADisable)
		router.OPTIONS("/api/auth/2fa/disable", auth.Options2FADisable)
		...
		router.GET("/api/analyses/dividends-by-year-month-data", analysesCtl.GetDividendsByYearMonthData)
		router.OPTIONS("/api/analyses/dividends-by-year-month-data", analysesCtl.Options)
		router.GET("/api/analyses/dividends-by-security-year-data", analysesCtl.GetDividendsBySecurityYearData)
		router.OPTIONS("/api/analyses/dividends-by-security-year-data", analysesCtl.Options)
		router.POST("/api/analyses/dividends-by-year-month-security-data", analysesCtl.PostDividendsByYearMonthSecurityData)
		router.OPTIONS("/api/analyses/dividends-by-year-month-security-data", analysesCtl.Options)
		...
		router.GET("/api/analyses/dividends-by-year-month-chart", analysesCtl.GetDividendsByYearMonthChart)
		router.OPTIONS("/api/analyses/dividends-by-year-month-chart", analysesCtl.Options)
		router.GET("/api/analyses/dividends-by-security-month-share-chart", analysesCtl.GetDividendsBySecurityMonthShareChart)
		router.OPTIONS("/api/analyses/dividends-by-security-month-share-chart", analysesCtl.Options)
		router.GET("/api/analyses/dividends-by-security-year-share-chart", analysesCtl.GetDividendsBySecurityYearShareChart)
		router.OPTIONS("/api/analyses/dividends-by-security-year-share-chart", analysesCtl.Options)
